...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { description: @objective.description, period_value: @objective.period_value, tiempo_id: @objective.tiempo_id } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { description: @objective.description, period_value: @objective.period_value, tiempo_id: @objective.tiempo_id } }
